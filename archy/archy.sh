...
menu_entorno() {
    while true; do
        ...
        echo "1. $MSG_MENU_ENTORNO_1"
        echo "2. $MSG_MENU_ENTORNO_2"
        echo "3. $MSG_BACK"
        read -p "$MSG_CHOOSE" op
        case "$op" in
            1) run_script "$SCRIPT_DIR/scripts/entornos/end4_completo.sh"; break ;;
            2) run_script "$SCRIPT_DIR/scripts/entornos/sddm.sh"; break ;;
            3) break ;;
            *) echo "$MSG_INVALID" ;;
        esac
    done
...
menu_predeterminadas() {
    while true; do
        ...
        run_script "$SCRIPT_DIR/scripts/entornos/end4_completo.sh"
